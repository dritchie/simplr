...
local terra testSampler()
	...
	var circle = Circle2d1d.heapAlloc(Vec2d.stackAlloc(0.4, 0.5), 0.1)
	var coloredCircle = ConstColorShape2d1d.heapAlloc(circle, Color1d.stackAlloc(1.0))
	var circle2 = Circle2d1d.heapAlloc(Vec2d.stackAlloc(0.6, 0.5), 0.1)
	var coloredCircle2 = ConstColorShape2d1d.heapAlloc(circle2, Color1d.stackAlloc(1.0))
	var circle3 = Circle2d1d.heapAlloc(Vec2d.stackAlloc(0.5, 0.7), 0.1)
	var coloredCircle3 = ConstColorShape2d1d.heapAlloc(circle3, Color1d.stackAlloc(1.0))
	-- var capsule = Capsule2d1d.heapAlloc(Vec2d.stackAlloc(0.5, 0.2), Vec2d.stackAlloc(0.5, 0.8), 0.05)
